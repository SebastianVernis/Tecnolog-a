...
def menu_tests():
    ...
    while True:
        ...
        if choice == '0':
            ...
            test_results = Path('scripts/test/test_flujo_completo_resultado.json')
...
def menu_documentacion():
    ...
    while True:
        ...
        print_menu("📚 DOCUMENTACIÓN", [
            ...
            ('3', '📊 RESUMEN-FLUJO - Resumen ejecutivo (1 página)'),
...
def menu_utilidades():
    ...
    while True:
        ...
        if choice == '0':
            ...
            if confirm == 's':
                import shutil
                dirs_to_clean = ['generated_sites', 'generated_sites_test', 'test_output_modules']
            ...
            print(f"    - Total módulos: 16")
            print(f"    - Uso directo: 8")
            ...
            print(f"    - Imágenes AI: 21 (20 + logo)")
